...
with open('../tweepy/tweets_with_hashtag_'+ hashtag + '.csv', 'a', encoding = 'utf-8') as the_file:
	writer = csv.writer(the_file)
	writer.writerow(['userId',"userName", 'created_at', 'message',"location","retweeted_id","followers"])
	backoff_counter = 1
	while True:
		try:
